<?php
 ...
 $id = &$_GET['id'];
 $sql = "DELETE FROM tbl_patient_info WHERE id=$id ";
...
<body>
        ...
        <div class="add-data" id="entryform" >
            <div class="insert">
                ...
                <form id="addData" action="operation.php" method="post">
        ...
        <div class="edit-data" id="editform" >
            <div class="editinsert">
                <div class="editinsertheader">
                    ...
                    <h3><label for="fullname">Patient Fullname</label></h3>
                    <input type="text" name="fullname"  value="<?php echo $row['fullname']; ?>" class="box" required>   
                    <h3><label for="nationality">Patient Nationality</label></h3>
                    <input type="text" name="nationality" value="<?php echo $row['nationality']; ?>" class="box" required>
                    
                    <h3><label for="gender">Patient Gender</label></h3>
                    <select name="gender" id="gender" value="<?php echo $row['gender']; ?>" class="box" required>
                    ...
                    <h3><label for="mobile_no">Patient Mobile No.</label></h3>
                    <input type="text" name="mobileNo" value="<?php echo $row['mobileNo']; ?>" class="box" required>

                    <h3><label for="email_add">Patient eMail Address</label></h3>
                    <input type="text" name="email_add" value="<?php echo $row['email_add']; ?>" class="box" required>

                    <h3><label for="body_temp">Patient Body Temperature (°C)</label></h3>
                    <input type="text" name="body_temp" value="<?php echo $row['body_temp']; ?>" class="box" required>

                    <h3><label for="vaccinated">Is the Patient Vaccinated?</label></h3>
                    <select name="vax" id="vaccinated" value="<?php echo $row['vax']; ?>" class="box" required>
                    <option value="" disabled >Select YES/NO</option>
                    <option value="YES">YES</option>
                    <option value="NO">NO</option></select>

                    <h3><label for="encountered">Does the Patient Encountered other Covid Patients?</label></h3>
                    <select name="cov_enc" id="encountered" value="<?php echo $row['cov_enc']; ?>" class="box" required>
                    <option value="" disabled >Select YES/NO</option>
                    <option value="YES">YES</option>
                    <option value="NO">NO</option></select>
                    
                    <h3><label for="diagnosed">Does the Patient Diagnosed with Covid?</label></h3>
                    <select name="cov_diag" id="diagnosed" value="<?php echo $row['cov_diag']; ?>" class="box" required>
                    <option value="" disabled >Select YES/NO</option>
                    <option value="YES">YES</option>
                    <option value="NO">NO</option></select>
                    
                    <input type="submit" name="dalete" value="Delete" class="btn" onclick="return confirmDelete();">
                </form>
            </div>
        </div>
